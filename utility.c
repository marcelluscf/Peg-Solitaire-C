...
void read_rest_of_line(void)			//header in line 12 from utility.h
{
    int ch;
...
char *get_input(char *buffer)			//header in line 15 from utility.h
{
...
int letter_to_number(char c)			//header in line 20 from utility.h
{
    return c - 'A';
}
